...
public class MovieTester {
	...
	public static void main(String[] args)
	{
		...
		//challenge 2
		System.out.println("\nChallenge: ValuableMovie");
		System.out.println("The Underrate Movie whose Rotten Tomatoes scores are Higher Than  74 and Worldwide Gross Less Than Average \n\t" + catalog.searchUnderrateMovie().toString().replaceAll(" Movie", "\n\tMovie"));//challenge 2
